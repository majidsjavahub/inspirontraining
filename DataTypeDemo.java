...
public class DataTypeDemo {
	...
	public static void main(String[] args) {
		...
		int d = b * c;// the result of a arithmetic operation will give u a integer by default - type
		...
		// int %i; - Variable name cannot start with a special character other than $
		// and _ .
		int _i;// valid identifier - _ is accepted
		int $i;// valid identifier - $ is accepted
		int money$_1;// valid identifier - can also be combination - number can be added in between
						// or at the end.
